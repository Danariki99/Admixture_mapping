...
keep_file="/private/groups/ioannidislab/smeriglio/out_cleaned_codes/kcutoff_0442/kcutoff_0442.king.cutoff.in.id"
...
do
    ...
    output_dir="/private/groups/ioannidislab/smeriglio/out_cleaned_codes/output_distributions_kcutoff_0442/${dataset}/output_ancestry_${anc}/$pheno"
    mkdir -p $output_dir
