...
sbatch_dir="/private/home/rsmerigl/codes/Admixture_mapping/association_execution/new_association/BMI_OCE"
...
do
    ...
    do
        ...
        mkdir -p "/private/groups/ioannidislab/smeriglio/output_OCE/BMI/$pheno_base"
        output_file="/private/groups/ioannidislab/smeriglio/output_OCE/BMI/$pheno_base/output"

        # Command to run
        command_to_run="/private/home/rsmerigl/plink2 --vcf $vcf_file --pheno $current_pheno_file --glm firth-fallback hide-covar --ci 0.95 --adjust --covar $covar_file --covar-variance-standardize --keep $keep_file --out $output_file --covar-col-nums 2-4,93"
