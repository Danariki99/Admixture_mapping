...
sbatch_dir="/private/home/rsmerigl/codes/Admixture_mapping/association_execution/new_association/BMI"
...
do
    ...
    do
        ...
        output_file="/private/groups/ioannidislab/smeriglio/output/BMI/output_ancestry_${anc}/$pheno_base/output"
