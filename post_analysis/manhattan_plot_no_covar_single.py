...
if __name__ == '__main__':
    ...
    for hit in os.listdir(res_folder):
        ...
        output_file = f'/private/groups/ioannidislab/smeriglio/out_cleaned_codes/vcf_files_windows/ukbb/fine_mapping_plots/no_covar/single/manhattan_plot_{hit}.{hit.split("_")[0]}.png'
