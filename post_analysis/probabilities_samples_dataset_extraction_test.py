...
hit_folder = os.path.join(result_folder, 'probabilities_pipeline/models')
...
output_folder = os.path.join(result_folder, 'probabilities_pipeline/samples')
tmp_folder = os.path.join(result_folder, 'probabilities_pipeline/tmp')
