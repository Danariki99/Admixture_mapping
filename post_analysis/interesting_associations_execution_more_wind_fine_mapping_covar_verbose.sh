...
ancestry_list=("AFR" "EAS" "EUR" "NAT" "SAS" "WAS")
...
do
    ...
    output_folder=/private/groups/ioannidislab/smeriglio/out_cleaned_codes/vcf_files_windows/${dataset}/fine_mapping_ancestries_PCA_verbose/${keep_filename/_keep_chr$chrom.txt}_chr$chrom
    ...
    do
        ...
        covar_file="/private/groups/ioannidislab/smeriglio/out_cleaned_codes/vcf_files_windows/$dataset/PCA_files/PCA_covar_files/${keep_filename/keep/covar}"
        ...
        command_to_run="/private/home/rsmerigl/plink2 --vcf $vcf_file --pheno $phe_file --glm firth-fallback intercept --ci 0.95 --adjust --covar $covar_file --extract $snps_file --covar-variance-standardize --keep $keep_file --out $output_file --covar-col-nums 2-15"
