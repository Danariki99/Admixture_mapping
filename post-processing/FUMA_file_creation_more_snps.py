...
output_folder_generic = '/private/groups/ioannidislab/smeriglio/FUMA_all_snps/*/'

generic_snps_filename = '/private/groups/ioannidislab/smeriglio/output/*/significant_SNPs_with_P_values.txt'
