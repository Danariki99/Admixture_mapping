...
def manhattan_plot(folder):
    ...
    for pheno in phenotypes:
        ...
        merged_df=merged_df.rename(columns={'BONF':'P'})
...
manhattan_plot('/private/groups/ioannidislab/smeriglio/output/no_BMI/output_ancestry_EUR/')
